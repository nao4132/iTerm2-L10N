...
- (NSMenu *)menuAtCoord:(VT100GridCoord)coord {
    ...
    __block NSString *scpTitle = NSLocalizedStringFromTableInBundle(@"Download with scp",
								    @"iTerm",
    ...
    [theMenu addItemWithTitle:NSLocalizedStringFromTableInBundle(@"Send Selection",
		       ...
		       action:@selector(sendSelection:)
                keyEquivalent:@""];
    [[theMenu itemAtIndex:[theMenu numberOfItems] - 1] setTarget:self];
    [theMenu addItemWithTitle:NSLocalizedStringFromTableInBundle(@"Save Selection as Snippet",
								 @"iTerm",
								 [NSBundle bundleForClass: [self class]],
								 @"Context menu")
